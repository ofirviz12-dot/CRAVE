                    ...
                    .addSnapshotListener { postsSnapshot, e ->
                        ...
                        if (postsSnapshot != null) {
                            for (document in postsSnapshot) {
                                ...
                                totalLikes += likedByArray?.size ?: 0
                            }
                        }

                        val totalLikesWithBonus = totalLikes + 1020
                        val earnedCoins = totalLikesWithBonus / 10
                        val progressInWheel = totalLikesWithBonus % 10
            ...
            if (btnAction.text == "BUY NOW") {
                ...
                if (amountString.isNotEmpty()) {
                    ...
                    if (amountToBuy <= currentCoinsBalance) {
                        ...
                        requireContext().showCustomPopup("Not enough coins!")
                    }
                } else {
